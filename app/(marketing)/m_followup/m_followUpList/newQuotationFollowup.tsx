...
import { SalesFollowupInsert, SalesQuotationFollowup } from "~/types/followup";
import { useUserStore } from "~/store";
import Toast from "react-native-toast-message";
import { useInsertQuotationFollowup } from "~/hooks/followup";
...
const m_newfollowup = () => {
  ...
  const parsedData: SalesQuotationFollowup | undefined = JSON.parse(
    data || "{}"
  );

  const followupInsert = useInsertQuotationFollowup();
